...
using SaleMicroservice.DataAccess.Repositories;
...
namespace Sales.Microservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SaleMicroserviceContext>(options =>
                options.UseMySql(connectionString, ServerVersion.AutoDetect(connectionString)));

            services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<SaleMicroserviceContext>();

            services.AddTransient<ISaleAppServices, SaleAppServices>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env/*, SaleMicroserviceContext db*/)
        {
